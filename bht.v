module bht (
	...
	always @(posedge clk) begin 
		...
		if (branch_MEM_WB ) begin  // I removed | branch_MEM_WB to check if my guess is right | branch_MEM_WB	
	 ...
	 reg [1:0] current_state, next_state ; 
		 ...
		 if (branch_EX_MEM) begin 
			 flag4 = 1'b1 ;  
		  	 ...
		  	 next_state = history[previous_prediction_addr_ID_EX] ; //from EX/MEM -> I changed it to ID/EX because the RHS is clocked. 
			 flag5 = 1'b1 ; 
		 end  
         end
